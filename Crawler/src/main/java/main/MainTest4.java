...
public class MainTest4 {
    ...
    private static Logger log = Logger.getLogger(MainTest4.class.getClass());
    ...
    public static Map<String, Object> initYml() {
        ...
        Yaml yaml = new Yaml();
        OptionsEntity optionsEntity = yaml.loadAs(MainTest4.class.getResourceAsStream("/prop/init.yml"), OptionsEntity.class);
