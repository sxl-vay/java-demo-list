...
public class AddTests {
    ...
    public static void main(String[] args) {
        AddTests restfulDemo = new AddTests();
    ...
    public void doAction() {
        ...
        detailData.put("lxdz","");
        detailData.put("qyfmcwb","0002");
        detailData.put("lxr","ceshi");
        detailData.put("id","");
        deatil.put("data", detailData);
        deatilTable.add(deatil);
        data.put("detail1", deatilTable);
